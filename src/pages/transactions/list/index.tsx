...
import { useGetCompaniesQuery, usePostEmployeeSearchQuery, usePostEnrollmentSearchQuery } from 'src/store/api/apiHooks'
...
const arrayContainsFilterOperator: GridFilterOperator = {
  label: 'is assigned',
  value: 'isAssigned',
  getApplyFilterFn: (filterItem) => {
    ...
    return ({ value }) => {
      const employeeIds: string[] = value.map((e: ProfileAssigneeType) => e.employeeId) || [];

      return employeeIds.includes(filterValue);
    };
  },
