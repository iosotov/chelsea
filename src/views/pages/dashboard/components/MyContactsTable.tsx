...
import { selectAllProfiles, selectProfilesByStatus, selectProfilesByProfileAssignee } from 'src/store/profileSlice'
import {
...
export const paymentStatusColor: ThemeColor[] = [
  'primary',
  'info',
  'success',
  'error',
...
const MyContactsTable = () => {
  ...
  const profiles = [
    useAppSelector(state => selectProfilesByProfileAssignee(state, employee.employeeId)),
