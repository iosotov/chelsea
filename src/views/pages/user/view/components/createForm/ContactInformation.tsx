...
function ContactForm({ field, index, errors, control }: ContactFormProps) {
  return field.type === 1 ? (
    <FieldArrEmailInput
      ...
      errors={
        errors?.profileContacts && errors?.profileContacts.length && errors?.profileContacts[index]?.value
          ? true
          : false
      }
      errMsg={
        errors?.profileContacts && errors?.profileContacts.length && errors?.profileContacts[index]?.value
          ? errors?.profileContacts[index]?.value?.message
          : ''
      }
    />
  ) : (
      ...
      <Grid container spacing={4} mb={6}>
        <Grid key={field.id} item xs={12}>
          <FieldArrTextInput
            ...
            control={control}
            errors={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.address1
                ? true
                : false
            }
            errMessage={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.address1
                ? errors?.profileAddresses[index]?.address1?.message
                : ''
            }
          />
        </Grid>
        <Grid item xs={12}>
          <FieldArrTextInput
            ...
            control={control}
            errors={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.address2
                ? true
                : false
            }
            errMessage={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.address2
                ? errors?.profileAddresses[index]?.address2?.message
                : ''
            }
          />
        </Grid>
        <Grid item xs={12} md={7}>
          <FieldArrTextInput
            ...
            required={index === 0}
            errors={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.city
                ? true
                : false
            }
            errMessage={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.city
                ? errors?.profileAddresses[index]?.city?.message
                : ''
            }
          />
        </Grid>
        <Grid item xs={12} md={2}>
          <FieldArrSingleSelect
            ...
            control={control}
            errors={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.state
                ? true
                : false
            }
            errMsg={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.state
                ? errors?.profileAddresses[index]?.state?.message
                : ''
            }
          />
        </Grid>
        <Grid item xs={12} md={3}>
          <FieldArrZipCode
            ...
            control={control}
            errors={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.zipCode
                ? true
                : false
            }
            errMsg={
              errors?.profileAddresses && errors?.profileAddresses.length && errors?.profileAddresses[index]?.zipCode
                ? errors?.profileAddresses[index]?.zipCode?.message
                : ''
            }
          />
        </Grid>
