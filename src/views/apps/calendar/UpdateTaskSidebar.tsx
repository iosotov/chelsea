...
import { TaskCreateType, TaskType } from 'src/store/api/taskApiSlice'
...
const defaultState: TaskCreateType = {
  "taskName": "",
  "status": 0,
  "dueDate": "",
  "assignedTo": "",
...
type AddTaskSidebarType = {
  ...
  setSelectedTask: React.Dispatch<SetStateAction<TaskType | null>>
    ...
    >
      ...
      >
        <Typography variant='h6'>
          {selectedTask === null ? "Create Task" : "Update Task"}
        </Typography>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          {selectedTask?.taskId.length ? (
            <IconButton
              ...
              sx={{ color: 'text.primary', mr: selectedTask !== null ? 1 : 0 }}
            >
